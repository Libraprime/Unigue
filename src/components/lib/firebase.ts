...
// 1. Initialize App (Singleton pattern to prevent "already exists" errors)
const app = getApps().length > 0 ? getApp() : initializeApp(firebaseConfig);

// 2. Initialize DB and Auth immediately
// These are safe to initialize; they won't run network calls until used.
